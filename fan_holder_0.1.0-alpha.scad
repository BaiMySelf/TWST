...
module fanDuctBasePlate(){
    ...
    difference(){
        ...
        translate([5, 5, 0])cylinder(h = 1, d = 8);
        
        //spilt plate
        translate([0, 5, 0])cube([10, 0.5, 1]);
        translate([0, 4.5, 0])cube([10, 0.5, 1]);
        
    }
    
    //clamps
        translate([-1.5, 5.15, 0])cube([2.5, 0.4, 1]);
        translate([9, 5.15, 0])cube([2.5, 0.4, 1]);
    
        translate([-1.5, 4.45, 0])cube([2.5, 0.4, 1]);
        translate([9, 4.45, 0])cube([2.5, 0.4, 1]);
